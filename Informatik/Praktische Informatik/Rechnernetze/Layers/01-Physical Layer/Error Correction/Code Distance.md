The **Code Distance** is a metric which conveys the minimum distance (amount of bits to change) so that any two different code words match. The code distance is a great indicator for error tolerance.
